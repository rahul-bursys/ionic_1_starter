...
`javascript`  |  javascript is a scripting Langugage.It is light-weight and most commonly used language.It is an interpreted                  programming language with object-oriented capabilities.Javascript first know as Livescript but netscape                      change its name to javascript,possibly because of the excitement being generated by Java. 
